...
GROUNDING_DINO_CONFIG_PATH = r"C:\Users\TUM_LfK\anaconda3\envs\hci_env\Lib\site-packages\groundingdino_py-0.1.0-py3.9.egg\groundingdino\config\GroundingDINO_SwinT_OGC.py"
...
def option(user_message):
    ...
    response=api_answer(session['option_messages'], "json")
    try:
